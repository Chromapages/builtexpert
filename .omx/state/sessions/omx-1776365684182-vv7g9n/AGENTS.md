...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776365684182-vv7g9n | 2026-04-16T18:54:54.031Z

**Codebase Map:**
  src/: ._App, ._main, App, main
  src/components/: ._Analytics, ._SEO, ._ScrollToTop, Analytics, SEO, ScrollToTop, ._AuditOfferHighlight, ._FAQSection, ._GlobalCTA, ._HomeHero
  src/data/: ._caseStudies, ._detailPages, caseStudies, detailPages
  src/hooks/: ._useMagnetic, useMagnetic
  src/lib/: ._animation, ._industrialStyle, ._performance, ._sanity.client, ._utils, animation, crm, industrialStyle, performance, sanity.client
  src/pages/: .!807!WhoWeHelp, ._.!807!WhoWeHelp, ._About, ._Audit, ._AuditSuccess, ._Blog, ._CaseStudy, ._Checklist, ._Contact, ._Home
  scripts/: ._seed-sanity, fix-ref-title, seed-sanity
  api/: ._create-audit-session, ._hvac-audit-intake, ._lead-intake, ._stripe-webhook, ._discord, discord, create-audit-session, hvac-audit-intake, lead-intake, stripe-webhook
  sanity/: ._structure, ._auditDeliverable, ._auditIntakeSubmission, ._auditOffer, ._author, ._caseStudy, ._cityPage, ._faqItem, ._footer, ._homePage
  (root): ._sanity.cli, ._sanity.config, ._vite.con...
